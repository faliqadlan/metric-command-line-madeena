...
def get_folder_paths():
    ...
    folder_paths = []
    print("=" * 50)
    print("📁 PILIH FOLDER GAMBAR")
    print("=" * 50)
    print("Masukkan alamat folder yang berisi gambar Anda.")
    print("Contoh: C:\\Users\\Nama\\Documents\\Gambar")
    print("")
    print("⚠️  PENTING - FORMAT NAMA FILE:")
    print("   File gambar HARUS memiliki format: NOMOR_NAMAFILE")
    print("   Contoh yang BENAR:")
    print("   • 1_gambar1.jpg")
    print("   • 2_foto_dada.png")
    print("   • 3_medical_image.tiff")
    print("")
    print("   Contoh yang SALAH:")
    print("   • gambar1.jpg (tidak ada nomor)")
    print("   • 1-gambar1.jpg (pakai tanda - bukan _)")
    print("   • foto_1.jpg (nomor di belakang)")
    print("")
...
def get_mask_method():
    ...
    print("\n" + "=" * 50)
    print("🎯 PILIHAN AREA ANALISIS GAMBAR UNTUK CII")
    print("=" * 50)
    print("🔬 MENGAPA PARAMETER INI PENTING UNTUK CII?")
    print("")
    print("CII (Contrast Improvement Index) mengukur peningkatan kontras antara")
    print("area foreground (objek penting) dan background (latar belakang).")
    print("Area analisis yang tepat akan memberikan hasil CII yang lebih akurat.")
    print("")
    print("🎯 PILIHAN AREA ANALISIS:")
    print("")
    print("1. 📊 Seluruh Gambar")
    print("   → Menganalisis semua bagian gambar")
    print("")
    print("2. 🔍 Otsu Otomatis (Algoritma Thresholding Otsu)")
    print("   → Program otomatis memilih area penting berdasarkan histogram")
    print("")
    print("3. 🎨 Adaptif Cerdas (Adaptive Gaussian Thresholding)")
    print("   → Menyesuaikan threshold berdasarkan area lokal di sekitar pixel")
    print("")
    print("4. 📈 Berdasarkan Kecerahan (Percentile 75%)")
    print("   → Fokus pada 25% area terpintar dalam gambar")
    print("")
    print("🚨 REKOMENDASI BERDASARKAN JENIS GAMBAR:")
    print("   • Gambar medis/X-ray: Pilihan 4 (Percentile)")
    print("   • Gambar dengan objek jelas: Pilihan 2 (Otsu)")
    print("   • Gambar dengan noise/lighting tidak merata: Pilihan 3 (Adaptif)")
    print("   • Tidak yakin/pemula: Pilihan 1 (Seluruh Gambar)")
    print("")
    ...
    while True:
        try:
            ...
            if not choice:
                ...
                print("   💬 Analisis akan menggunakan seluruh area gambar")
                return "none"
            ...
            if choice == 1:
                ...
                print("   💬 Program akan mencari threshold optimal secara otomatis")
                print("   ⚙️  Algoritma: Binary thresholding dengan metode Otsu")
                return "otsu"
            elif choice == 3:
                print("✅ Dipilih: Adaptif Cerdas")
                print("   💬 Threshold akan disesuaikan per area lokal")
                print("   ⚙️  Algoritma: Adaptive Gaussian thresholding (kernel 11x11)")
                return "adaptive"
            elif choice == 4:
                print("✅ Dipilih: Berdasarkan Kecerahan")
                print("   💬 Fokus pada 25% area terpintar (percentile 75%)")
                print("   ⚙️  Metode: Percentile-based thresholding")
                return "percentile"
            else:
...
def main():
    ...
    try:
        ...
        print("kualitas gambar dengan menghitung metrik:")
        print("• ENT (Entropi)")
        ...
        print("   Contoh: 1_gambar1.jpg di folder A vs 1_foto.jpg di folder B")
        ...
        if not all_image_numbers:
            ...
            print("NOMOR_NAMAFILE (contoh: 1_gambar1.jpg, 2_foto.png)")
            print("")
